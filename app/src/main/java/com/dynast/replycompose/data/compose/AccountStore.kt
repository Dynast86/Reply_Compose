package com.dynast.replycompose.data.compose
...
object AccountStore {
    ...
    private val _userAccounts: MutableStateFlow<List<Account>> = MutableStateFlow(
        emptyList()
    )

    val userAccounts: StateFlow<List<Account>>
        get() = _userAccounts
